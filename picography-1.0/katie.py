...
def katie():
    ...
    timespan("1988-04-08", "2017-08-01", year_height=52, legend=True)
    ...
    roomate(1, "Chip", "2004-08-18", "2005-06-15")
    roomate(2, "Mara and Darcy", "2007-09-20", "2008-05-20")
    roomate(1, "Alison (and Sonny and Will)", "2010-09-01", "2011-06-01")
    roomate(1, "Chris and Megan", "2011-06-01", "2012-09-01")
    roomate(3, "Sarah", "2012-09-01", "2013-09-01")
    roomate(2, "Johnicholas", "2013-09-01", "2017-08-01")
