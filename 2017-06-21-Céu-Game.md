...
My finished program has some **errors** at compile time. I would have been pretty concerned about these without Johnicholas's help. Céu warns me that I have *tight loops*, or unbounded loops.
...
One way to rewrite the tight loops which Céu is warning me about would be Ceu's ```await async (variable) do```. Next time!
